...
class Voice:    
    def __init__(self, input_file):
        ...
        self.df = pd.read_csv("C:/Users/gkdus/PJ/fluter/nugunyaneon/nugunyaneon01/nugunyaneon_backend/nugunyaneon_app/test_media/500_가중치.csv", encoding='utf-8')      # 전체 형태소 분석 (가중치) 파일 
        self.type_df = pd.read_csv("C:/Users/gkdus/PJ/fluter/nugunyaneon/nugunyaneon01/nugunyaneon_backend/nugunyaneon_app/test_media/type_token_가중치.csv", encoding='utf-8') # 범죄 유형 분류 기준 단어 파일
